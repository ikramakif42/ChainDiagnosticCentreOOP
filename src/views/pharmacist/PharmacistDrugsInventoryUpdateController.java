 ...
 * @author User
 */
public class PharmacistDrugsInventoryUpdateController implements Initializable {

    @FXML
    private TextField pharmaDrugsQuantityUpdate;
    ...
    @FXML
    private void pharmaDrugsInventoryUpdateOnClick(ActionEvent event) {
    }

    @FXML
    private void pharmaDrugsInventoryBackOnClick(ActionEvent event) throws IOException {

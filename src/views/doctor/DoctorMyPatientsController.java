...
public class DoctorMyPatientsController implements Initializable {
    ...
    @FXML
    private TableColumn<?, ?> medicalRecordTableColumn;
    @FXML
    private TableColumn<?, ?> prescribeMedicationTableColumn;
    @FXML
    private TableColumn<?, ?> labResultTableColumn;
    @FXML
    private TableColumn<?, ?> viewBillingInfoTableColumn;
    @FXML

 ...
 * @author arafath
 */
public class RetrievePatientHistoryTestResultsController implements Initializable {
    ...
    @FXML
    private void PatientExistenceOnClick(ActionEvent event) {
    }

    @FXML
    private void ReturnPatientHistoryResultOnClick(ActionEvent event) throws IOException {
    ...
    @FXML
    private void SubmitPatientHistoryOnClick(ActionEvent event) {
    }

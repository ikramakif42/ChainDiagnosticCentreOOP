...
public class Pharmacist extends Employee implements Serializable{
    ...
    public Pharmacist(String designation, String department, Float salary, LocalDate DOJ, String branchName, String name, int ID, String password, String email, String contactNo, String address, LocalDate DOB) {

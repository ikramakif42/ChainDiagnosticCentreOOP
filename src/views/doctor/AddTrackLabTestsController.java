...
public class AddTrackLabTestsController implements Initializable {
    ...
    private void returnToMyPatientsOnClick(ActionEvent event) throws IOException {
        ...
        FXMLLoader doctorMyPatientsLoader = new FXMLLoader(getClass().getResource("DoctorDashboard.fxml"));
        doctorMyPatients = (Parent) doctorMyPatientsLoader.load();
        Scene doctorScene = new Scene(doctorMyPatients);

        DoctorMyPatientsController d = doctorMyPatientsLoader.getController();
        d.setDoc(this.doc);
